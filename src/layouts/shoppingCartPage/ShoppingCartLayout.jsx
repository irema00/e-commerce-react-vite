...
const ShoppingCartLayout = () => {
  ...
  console.log("SEPET ÜRÜNLERİ", cartItems);
  return (
    <div className="container mx-auto my-6 p-4 bg-ltGrey rounded-xl flex justify-between gap-10">
      <div className="flex flex-col w-full">
        ...
        {isShippingFree(total) ? (
          <div className="text-green-600 font-bold mb-2">Free Shipping!</div>
        ) : (
            ...
            return (
              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  />
                  <p className="font-semibold w-[300px]">{item.product.name}</p>
                </div>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm font-normal lg:text-[18px] text-[20px]">
                  {isShippingFree(total) ? (
                    <div className="flex gap-2">
                      <span className="text-blue-500 line-through">$29.99</span>
